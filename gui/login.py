...
from PySide6.QtWidgets import (QCheckBox, QDialog, QFileDialog, QGroupBox,
...
class LoginWindow(QDialog):
        ...
        try:
            ...
            if self.app_manager.db.unlock(password):
                ...
                QMessageBox.critical(
                    self, "Error", "Invalid password or database format"
                )
    ...
    def create_database(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(
            self, "Create Database", "", "SecurePass Database (*.spdb);;All Files (*)"
        )
        ...
        if len(password) < 12:
            QMessageBox.warning(
                self, "Weak Password", "Master password must be at least 12 characters"
            )
            return
        ...
        try:
            ...
            QMessageBox.information(
                self, "Success", f"New database created at:\n{file_path}"
            )
