...
from PySide6.QtWidgets import (
    ...
    QLineEdit, QLabel, QFormLayout, QGroupBox, QMessageBox, QSplitter, 
    QListWidgetItem, QToolBar, QStatusBar, QApplication, QProgressBar,
    QComboBox, QDialog, QDialogButtonBox, QCheckBox, QFileDialog
)
...
class ProxySettingsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.system_wide_checkbox = QCheckBox("Apply System-wide (Admin may be required)")
        layout.addRow(self.system_wide_checkbox)
        
        # Info label
        self.info_label = QLabel("Note: System-wide proxy requires admin privileges on some systems")
    ...
    def accept(self):
        ...
        if self.enable_proxy.isChecked():
            ...
            if not host:
                QMessageBox.warning(self, "Invalid Input", "Host is required when proxy is enabled.")
                return
            ...
            if self.auth_checkbox.isChecked():
                username = self.username_input.text().strip()
                if not username:
                    QMessageBox.warning(self, "Invalid Input", "Username is required for authentication.")
                    return
...
class MainWindow(QMainWindow):
    def __init__(self, app_manager):
        ...
        self.category_filter.addItems(["Social", "Email", "Work", "Finance", "Shopping", 
        "Gaming", "Streaming", "Developer", "Travel", "Health", "Government", "Miscellaneous"])
        ...
        self.category_combo.addItems(["Social", "Email", "Work", "Finance", "Shopping", 
        "Gaming", "Streaming", "Developer", "Travel", "Health", "Government", "Miscellaneous"])
    ...
    def update_db_info(self):
        ...
        try:
            ...
            self.db_info.setText(f"Database: {db_name} | Location: {folder} | Passwords: {count}")
    ...
    def perform_backup_now(self):
        ...
        backup_settings = {
            ...
            "frequency": self.app_manager.proxy.settings.get("Backup/frequency", "Daily"),
    ...
    def filter_passwords(self):
        ...
        for i in range(self.password_list.count()):
            ...
            text_match = (search_text in service.lower() or 
    ...
    def copy_password(self):
        ...
        if password:
            ...
            self.status_bar.showMessage("Password copied to clipboard - will clear in 30 seconds", 3000)
    ...
    def show_firewall_status(self):
        ...
        protection = "Full system protection" if status == "Active" else "Limited protection"
